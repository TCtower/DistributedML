...
def get_loader(batch_size, worker_number, class_per):
    ...
    client_loaders = [torch.utils.data.DataLoader(CustomImageDataset(x, y, AlexTransform),
                                                  batch_size=batch_size, shuffle=True) for x, y in split]

    test_loader = torch.utils.data.DataLoader(CustomImageDataset(x_test, y_test, AlexTransform), batch_size=batch_size,
                                              shuffle=True)
