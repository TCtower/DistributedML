...
sys.path.append("..")
print(sys.path)
from src.models import alexnet, lr, resnet
...
def train(workers, train_data_list, test_data):
    ...
    if args.model == "alexnet":
        ...
        global_model = resnet.ResNet18().to(device)
    else:
    ...
    for i in workers:
        ...
        optimizer = MySGD(model.parameters(), lr=0.001)
...
if __name__ == '__main__':
    ...
    train_data_list, test_loader = data_utils.get_loader_customize(
        data_transform, batch_size, args.workers,
